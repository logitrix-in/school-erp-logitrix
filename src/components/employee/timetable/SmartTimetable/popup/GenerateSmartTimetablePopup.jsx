            ...
            <Box>
                ...
                <Box display="flex" flexDirection="column" gap={2} p={2} justifyContent="center" width={"90%"} margin="auto" alignItems="flex-start">
                    ...
                    <Box display={'flex'} flexDirection={'column'} justifyContent={'space-between'} gap={2} sx={{ width: '100%', mt: 2 }} >
                        ...
                        <Typography fontWeight={'medium'}>Mapping has been completed for the following classes :</Typography>
                        <Autocomplete
                    ...
                    <Typography marginY={2} textAlign={'center'} fontWeight={'medium'}>It is advisable to finish mapping for all the classes before generating smart timetable
