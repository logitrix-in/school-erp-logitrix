            ...
            <Box overflow={"hidden"}>
                ...
                <Box display="flex" flexDirection="column" gap={2} p={2} justifyContent="center" width={"90%"} margin="auto" alignItems="flex-start">
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }} >
                        <Typography fontWeight={"medium"} marginY={1}>Are you sure you want to release joining letter to the selected candidate?</Typography>
                    </Box>
