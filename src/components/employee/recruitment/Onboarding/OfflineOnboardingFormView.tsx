...
import Resubmission from "./popups/Resubmission";
...
const OnboardingDetails = () => {
  ...
  const [resubmissionPopup, setResubmissionPopup] = useState(false);
    ...
    <Box>
      ...
      <Box p={2}>
        ...
        <form onSubmit={handleSubmit(submit)}>
          ...
          <Resubmission
            open={resubmissionPopup}
            close={() => setResubmissionPopup(false)}
          />
