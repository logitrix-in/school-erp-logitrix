  ...
  return (
    <RevealCard>
      ...
      >
        ...
        {/* <DialogContent sx={{ overflowX: "auto", paddingBottom: "30px" }}>
          {sectionsList.map((sectionLabel, sectionIndex) => (
            <Box
              key={sectionLabel}
              sx={{
                display: "flex",
            ...
            >
              <Typography
                sx={{ fontSize: "16px", fontWeight: "700", color: "#585657" }}
              >
                {sectionLabel}
              </Typography>
              <Box sx={{ display: "flex", flexDirection: "row", gap: "10px" }}>
                {sections[sectionIndex]?.values.map((value, valueIndex) => (
                  <TextField
                    key={value.id}
                    label={`Section ${String.fromCharCode(
                ...
                {sections[sectionIndex]?.values.length > 1 && (
                  <Button
                    variant="contained"
                    size="small"
                    color="error"
