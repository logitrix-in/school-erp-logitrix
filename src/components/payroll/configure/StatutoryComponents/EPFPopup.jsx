...
const EPFPopup = ({ open, close }) => {
  ...
  return (
    ...
    >
      ...
      alignItems="center"
    >
      <Typography variant="subtitle1" alignSelf="flex-start">Enter New EPF Number :</Typography>
      ...
      <FormControl fullWidth>
        <InputLabel>Employee Contribution Rate</InputLabel>
        <Select
      ...
      <FormControl fullWidth>
        <InputLabel>Employer Contribution Rate</InputLabel>
        <Select
